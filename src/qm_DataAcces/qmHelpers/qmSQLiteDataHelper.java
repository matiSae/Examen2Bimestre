package qm_DataAcces.qmHelpers;
...
public abstract class qmSQLiteDataHelper <T>implements IqmDAO<T> {

    protected final Class<T>DTOClass;
    protected final String tableName;
    protected final String tablePK;

    private static final String DBPath = qmAppConfig.getDATABASE(); 
     ...
     */
    public qmSQLiteDataHelper(Class<T> DTOClass, String tableName, String tablePK) throws qmAppException {
        try {
            openConnection();
        } catch (SQLException e) {
            throw new qmAppException(null, e, getClass(), "DataHelperSQLiteDAO");
        }
    ...
    @Override
    public boolean create(T entity) throws qmAppException {
        ...
        try (PreparedStatement stmt = openConnection().prepareStatement(sql)) {
            ...
            throw new qmAppException(null, e, getClass(), "create");
        }
    }

    @Override
    public boolean update(T entity) throws qmAppException {
        try {
            Field[] fields = DTOClass.getDeclaredFields();
            ...
            throw new qmAppException(null, e, getClass(), "update");
        }
    }

    @Override
    public boolean delete(Integer id) throws qmAppException {
        ...
        try (PreparedStatement stmt = openConnection().prepareStatement(sql)) {
            ...
            throw new qmAppException(null, e, getClass(), "delete");
        }
    }

    @Override
    public T readBy(Integer id) throws qmAppException {
        ...
        try (PreparedStatement stmt = openConnection().prepareStatement(sql)) {
            ...
            throw new qmAppException(null, e, getClass(), "readBy");
        }
    }

    @Override
    public List<T> readAll() throws qmAppException {
        ...
        try (PreparedStatement stmt = openConnection().prepareStatement(sql);
            ...
            throw new qmAppException(null, e, getClass(), "readAll");
        }
        return list;
    }

    @Override
    public Integer getMaxReg(String tableCelName) throws qmAppException {
        String sql = String.format("SELECT MAX(%s) FROM %s WHERE Estado = 'A'", tableCelName, tableName);
        try (PreparedStatement stmt = openConnection().prepareStatement(sql);
             ResultSet rs = stmt.executeQuery()) {
            return rs.next() ? rs.getInt(1) : 0;
        } catch (SQLException e) {
            throw new qmAppException(null, e, getClass(), "getMaxReg(...)");
        }
    }
    @Override
    public Integer getMinReg(String tableCelName) throws qmAppException {
        String sql = String.format("SELECT MIN(%s) FROM %s WHERE Estado = 'A'", tableCelName, tableName);
        try (PreparedStatement stmt = openConnection().prepareStatement(sql);
             ResultSet rs = stmt.executeQuery()) {
            return rs.next() ? rs.getInt(1) : 0;
        } catch (SQLException e) {
            throw new qmAppException(null, e, getClass(), "getMinReg(...)");
        }
    }
    @Override
    public Integer getCountReg() throws qmAppException {
        ...
        try (PreparedStatement stmt = openConnection().prepareStatement(sql);
            ...
            throw new qmAppException(null, e, getClass(), "getCountReg(...)");
        }
    }

    protected T mapResultSetToEntity(ResultSet rs) throws qmAppException {
        try {
            ...
            throw new qmAppException(null, e, getClass(), "mapResultSetToEntity");
        }
    }
}
